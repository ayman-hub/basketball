  ...
  * // todo there is a problem with the server
  ...
  Future<dynamic> albumsScreenInitiation() async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/library?action=albums-listing"); //ResultModel.fromJson(response.data);
  ...
  json['offset'] = offset;
     // FormData formData = new FormData.fromMap(json);
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/library?action=albums-load-more&offset",queryParameters: json); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
        return GetAlbumScreenEntities.fromJson(response.data);
      } else {
  ...
  Future<dynamic> formScreenInitiation() async {
    try {
     ...
     // json['offset'] = "offset";
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/library?action=forms-listing",queryParameters: json); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> videosScreenInitiation() async {
    ...
    try {
     ...
     // json['action'] = "videos-listing";
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/library?action=videos-listing",queryParameters: json); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> singleVideoCategoryScreenInitiation(String id) async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/library?",queryParameters: json); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
        return GetVideosScreenEntities.fromJson(response.data);
      } else {
  ...
  Future<dynamic> singleVideoCategoryScreenOnScrollLoadMore(String id,String offset) async {
    try {
      Map<String, String> json = Map();
  ...
  Future<dynamic> teamsScreenInitiation() async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/teams?",queryParameters: json); //ResultModel.fromJson(response.data);
     print("here");
     // print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> singleTeamRelatedAlbumsScrollEvent(String teamID,String offset) async {
    try {
      Map<String, String> json = Map();
  ...
  Future<dynamic> singleTeamVideosScreenloadmorevideos(String teamID,String offset) async {
    try {
      Map<String, String> json = Map();
      ...
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
        return GetVideosScreenCategoriesLoadMoreEntities.fromJson(response.data);
      } else {
        print('responseModel ${ResponseModelFailure.fromJson(response.data)}');
        return ResponseModelFailure.fromJson(response.data);
      }
  ...
  Future<dynamic> getEtihadHistoreies() async {
    try {
     ...
     // json['offset'] = offset;
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/about-etihad?",queryParameters: json); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> getEtihadAchievementsCategoriesAndAchievementsRelateToThisCategory() async {
    try {
      Map<String, String> json = Map();
  ...
  Future<dynamic> latestNewsScreenInitalization() async {
    try {
     ...
     // json['offset'] = offset;
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/news?",queryParameters: json); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> listingAllRefrees() async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/game-elements?",queryParameters: json); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> homePageMatches(DateTime date) async {
    try {
      Map<String, String> json = Map();
      json['action'] = "matches";
      json['matches-date'] =/*"05/05/2021";*/"${date.day.toString().padLeft(2,"0")}/${date.month.toString().padLeft(2,"0")}/${date.year}";
      print(json);
      //json['offset'] = offset;
      // FormData formData = new FormData.fromMap(json);
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/pages/homepage.php?",queryParameters: json); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> listParentCategories() async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/competition?",queryParameters: json); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> childrenCompetitionInitiation(String c_id) async {
    try {
      ...
      if (response?.data['status'] == 'success') {
        print("here");
        GetChildCompetitionInitiationEntities.fromJson(response.data).data.matches.forEach((element) {
          print(element.teams);
        });
  ...
  Future<dynamic> childrenCompetitionInitiationForChildren(String c_id) async {
    try {
      ...
      if (response?.data['status'] == 'success') {
        print("here");
       // print(response.data['data']);
        print(GetChildCompetitionInitiationEntities.fromJson(response.data).toJson());
        return GetChildCompetitionInitiationEntities.fromJson(response.data);
      } else {
        print('responseModel ${ResponseModelFailure.fromJson(response.data)}');
        return ResponseModelFailure.fromJson(response.data);
  ...
  Future<dynamic> getJudgeMatchesEntities() async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/users/dashboard/judge-dashboard.php?",queryParameters: json,options: Options(headers: {"auth":"egybasket ${sl<Cases>().getLoginData().data.token}"})); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> forgetPassword(String email) async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.post("https://egypt.basketball/api/users/forgot-password/",
          data: formData); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
        return true;
  ...
  Future<dynamic> homePageSearch(String search) async {
    try {
     ...
     // json['password'] = password;
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.post("https://egypt.basketball//api/pages/homepage.php",
          data: formData); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> contactUs({String email ,String name ,String message ,String phone}) async {
    try {
      Map<String, String> json = Map();
     ...
     // json['password'] = password;
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.post("https://egypt.basketball/api/pages/contact-us/",
          data: formData); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
        return true;
  ...
  Future<dynamic> judgeRegister({String firstName,String lastName,String email,String password,String phone,String nationalID,String governmentID,String type}) async {
    try {
      print("type: $type");
      Map<String, String> json = Map();
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.post("https://egypt.basketball/api/users/registeration/judge-registeration.php",
          data: formData); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
        return true;
  ...
  Future<dynamic> userRegister({String firstName,String lastName,String email,String password,String phone}) async {
    try {
      Map<String, String> json = Map();
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.post("https://egypt.basketball/api/users/registeration/user-registeration.php",
          data: formData); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
        return true;
  ...
  Future<dynamic> judgeSeeNotification() async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.post("https://egypt.basketball/api/users/dashboard/judge-dashboard.php",
          data: formData,options: Options(headers: {"auth":"egybasket ${sl<Cases>().getLoginData().data.token}"})); //ResultModel.fromJson(response.data);
  ...
  Future<dynamic> homePageTable() async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.post("https://egypt.basketball//api/pages/homepage.php?action=homepage-table",
          data: formData); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> getEtihadDecision() async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/about-etihad?action=decisions-listing",
  ...
  Future<dynamic> socialMediaLogin(String name ,String email,RoleType role) async {
    try {
      Map<String, dynamic> json = Map();
  ...
  Future<dynamic> updateUserProfile(String phone,String nationalID,String bankName,String accountNo,String iban,String swiftCode) async {
    try {
      Map<String, dynamic> json = Map();
  ...
  Future<dynamic> startMatch(String matchID) async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.post("https://egypt.basketball/api/users/dashboard/single-match/",
          data: formData,options: Options(headers: {"auth":"egybasket ${sl<Cases>().getLoginData().data.token}"})); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
        return true;
  ...
  Future<dynamic> matchResultEntry(String matchID,String team1ID,String team2ID,String team1Points,String team2Points,
      { List<ReportPlayerEntities> reportPlayers /*= const[]*/}) async {
    try {
      Map<String, dynamic> json = Map();
      ...
      json['results'] = reportPlayers.map((e) =>
          "'${e.id}' => '${e.report}'").toList();
      FormData formData =
      new FormData.fromMap(json);
      print(json);
      dio.options.connectTimeout = 10000; //5s
  ...
  Future<dynamic> matchReportEntry(String matchID,String report,File image) async {
    try {
      Map<String, dynamic> json = Map();
  ...
  Future<dynamic> refereeReport() async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/users/dashboard/judge-dashboard.php?",
          queryParameters: json,options: Options(headers: {"auth":"egybasket ${sl<Cases>().getLoginData().data.token}"})); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> getMatchEntities(String matchID) async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/users/dashboard/single-match?",
          queryParameters: json,options: Options(headers: {"auth":"egybasket ${sl<Cases>().getLoginData().data.token}"})); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> getGovernmentEntities() async {
    try {
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/users/registeration/judge-registeration.php?",
          queryParameters: json,/*options: Options(headers: {"auth":"egybasket ${sl<Cases>().getLoginData().data.token}"})*/); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
  ...
  Future<dynamic> pushNotification(LoginDataEntities login,bool cancelNotification) async {
    try {
      ...
      json['fcm_token'] = cancelNotification == true?"": sl<Cases>().getNotificationFirebase();
      print("3");
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.post("https://egypt.basketball/api/users/fcm-token.php?action=update-fcmtoken",data: formData); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
        return true;
      } else {
...
/*      print("2");
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.post("https://egypt.basketball/api/users/dashboard/single-match/",data: formData,options: Options(headers: {"auth":"egybasket ${sl<Cases>().getLoginData().data.token}"})); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
        return true;
      } else {
...
*//*      print("2");
      ...
      dio.options.connectTimeout = 10000; //5s
      dio.options.receiveTimeout = 10000;
      response = await dio.get("https://egypt.basketball/api/users/dashboard/single-match?action=match-players&match_id=$matchID"/*,data: formData*/,options: Options(headers: {"auth":"egybasket ${sl<Cases>().getLoginData().data.token}"})); //ResultModel.fromJson(response.data);
      print("response in dio: ${response.data}");
      if (response?.data['status'] == 'success') {
