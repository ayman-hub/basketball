class GetManagerAccordingtoBranchesEntities {
  String status;
  String message;
  List<Data> data;

  GetManagerAccordingtoBranchesEntities({this.status, this.message, this.data});

  GetManagerAccordingtoBranchesEntities.fromJson(Map<String, dynamic> json) {
...
class Managers {
  ...
  Managers({this.id, this.title, this.position, this.thumb});
