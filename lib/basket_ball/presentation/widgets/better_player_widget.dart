...
//import 'package:better_player/better_player.dart' as video;
import 'package:video_player/video_player.dart';

class BetterPlayerWidget extends StatefulWidget {
  BetterPlayerWidget(this.url,{Key key}) : super(key: key);
String url;
  @override
  _BetterPlayerWidgetState createState() {
    return _BetterPlayerWidgetState();
  }
}
